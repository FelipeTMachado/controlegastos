...
<head>
    ...
    <title>Se controla AI - Cadastro</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>

<body class="bg-gray-900 text-gray-200">
    <div class="flex items-center justify-center min-h-screen">
        <form class="bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-sm" action="../controller/controller_cadastro.php" method="POST">
            <h2 class="text-2xl font-bold text-center text-gray-100 mb-6">Cadastre-se</h2>
            ...
            <div class="mb-4">
                ...
                <input class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" id="nome" name="nome" type="text" placeholder="Nome Completo" required>
            </div>
            ...
            <div class="mb-6">
                <label class="block text-gray-300 text-sm font-medium mb-2" for="confirmar_senha">
                    Confirmar Senha
                </label>
                <input class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" id="confirmar_senha" name="confirmar_senha" type="password" placeholder="**********" required>
            </div>
            ...
            <div class="mt-4 text-center">
                <a class="text-sm text-blue-400 hover:text-blue-500" href="login.php">Já tem uma conta? Faça login</a>
            </div>
        </form>
    </div>
</body>
